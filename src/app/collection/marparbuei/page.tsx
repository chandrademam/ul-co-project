...
export default function MarparbueiDetailPage() {
  ...
  const collections: CollectionItem[] = [
    {
      id: 1,
      name: "Heritage Odyssey Ensemble",
    ...
    {
      id: 2,
      name: "Contemporary Ritual Dress",
      image: "/image/marparbuei/3_2.jpg",
      description: "Dress yang terinspirasi dari pakaian upacara adat, dimodernisasi dengan cutting contemporary namun tetap mempertahankan sacred geometry dan symbolic elements",
      category: "Ceremonial Wear",
      inspiration: "Sacred Geometry",
    },
    {
      id: 3,
      name: "Ethnic Fusion Coordinates",
      image: "/image/marparbuei/3_3.jpg",
    ...
    {
      id: 4,
      name: "Traditional Tapestry Kimono",
      image: "/image/marparbuei/3_4.jpg",
      description: "Kimono-inspired outerwear yang mengintegrasikan teknik tenun tradisional Batak dengan desain flowing yang mencerminkan pergerakan dalam tarian adat",
      category: "Cultural Fusion",
      inspiration: "Dance Movement",
    },
    {
      id: 5,
      name: "Modern Ancestral Series",
      image: "/image/marparbuei/3_5.jpg",
      description: "Serangkaian pieces yang menghormati wisdom leluhur melalui contemporary interpretation, menggunakan earth tones dan organic shapes yang reflect connection dengan alam",
      category: "Ancestral Wisdom",
      inspiration: "Nature Connection",
    },
    {
      id: 6,
      name: "Complete Cultural Journey",
      image: "/image/marparbuei/3_5.jpg",
      description: "Koleksi komprehensif yang menyajikan narasi lengkap perjalanan budaya, dari tradisi masa lalu hingga visi masa depan, dalam harmoni warna dan tekstur yang sophisticated",
      category: "Complete Collection",
      inspiration: "Time Journey",
    },
  ];
